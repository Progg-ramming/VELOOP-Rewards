...
export default function GiveawayDetail({ slug }) {
  ...
  if (!prize) return <div className={styles.notFound}><h1>Giveaway not found</h1><p>This reward may have moved to the previous winners vault.</p><a href="/">Return to giveaway home</a></div>;
  const fee = prize.entry;
  ...
  return <div className={styles.detailShell}>
    <header className={styles.detailNav}><a href="/" className={styles.backLink}><ArrowLeft size={17} /> <span className={styles.desktopBack}>Giveaway home</span><span className={styles.mobileBack}>Giveaway</span></a><a className={styles.detailLogo} href="/"><span>V</span> VELOOP <small>REWARDS</small></a><a className={styles.supportLink} href="#support">Need help?</a></header>
    <main>
    ...
    <footer className={styles.detailFooter} id="support"><a href="/">Giveaway home</a><a href="/#rules">Rules</a><a href="#terms">Terms</a><a href="#support">Privacy</a><span>Questions? Contact VELOOP Rewards support.</span></footer>
